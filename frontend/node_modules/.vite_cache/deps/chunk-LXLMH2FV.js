...
} from "./chunk-6GFTUJ5A.js";
import {
  Typography_default,
  typographyClasses_default
} from "./chunk-IDUCKNFO.js";
import {
...
import {
  ...
  useForkRef_default,
  useId_default
} from "./chunk-4NHIMCKD.js";
import {
  capitalize_default,
  globalCss,
  memoTheme_default,
  useDefaultProps
} from "./chunk-PF7MZUZK.js";
import {
  getOverlayAlpha,
  identifier_default,
...
var ButtonBase = React35.forwardRef(function ButtonBase2(inProps, ref) {
  ...
  return (0, import_jsx_runtime29.jsxs)(ButtonBaseRoot, {
    ...
    ...buttonProps,
    ...other,
    children: [children, enableTouchRipple ? (0, import_jsx_runtime29.jsx)(TouchRipple_default, {
      ref: handleRippleRef,
      center: centerRipple,
      ...TouchRippleProps
    }) : null]
...
var IconButton = React36.forwardRef(function IconButton2(inProps, ref) {
  ...
  const loadingIndicator = loadingIndicatorProp ?? (0, import_jsx_runtime30.jsx)(CircularProgress_default, {
  ...
  return (0, import_jsx_runtime30.jsxs)(IconButtonRoot, {
    ...
    (0, import_jsx_runtime30.jsx)("span", {
      ...
      children: (0, import_jsx_runtime30.jsx)(IconButtonLoadingIndicator, {
  ...
  return (0, import_jsx_runtime31.jsx)(FormControlContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime31.jsx)(InputAdornmentRoot, {
      ...
      children: typeof children === "string" && !disableTypography ? (0, import_jsx_runtime31.jsx)(Typography_default, {
        color: "textSecondary",
        children
      }) : (0, import_jsx_runtime31.jsxs)(React37.Fragment, {
...
var Tab = React38.forwardRef(function Tab2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTab"
  });
  ...
  const icon = iconProp && label && React38.isValidElement(iconProp) ? React38.cloneElement(iconProp, {
  ...
  return (0, import_jsx_runtime32.jsxs)(TabRoot, {
    focusRipple: !disableFocusRipple,
    className: clsx_default(classes.root, className),
    ref,
    role: "tab",
    ...
    ...other,
    children: [iconPosition === "top" || iconPosition === "start" ? (0, import_jsx_runtime32.jsxs)(React38.Fragment, {
      children: [icon, label]
...
var KeyboardArrowLeft_default = createSvgIcon((0, import_jsx_runtime33.jsx)("path", {
...
var KeyboardArrowRight_default = createSvgIcon((0, import_jsx_runtime34.jsx)("path", {
...
var TabScrollButton = React41.forwardRef(function TabScrollButton2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTabScrollButton"
  });
...
function ScrollbarSize(props) {
  ...
  const scrollbarHeight = React42.useRef();
...
var Tabs = React43.forwardRef(function Tabs2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTabs"
  });
  ...
  const [indicatorStyle, setIndicatorStyle] = React43.useState(defaultIndicatorStyle);
  const [displayStartScroll, setDisplayStartScroll] = React43.useState(false);
  const [displayEndScroll, setDisplayEndScroll] = React43.useState(false);
  const [updateScrollObserver, setUpdateScrollObserver] = React43.useState(false);
  const [scrollerStyle, setScrollerStyle] = React43.useState({
    overflow: "hidden",
    scrollbarWidth: 0
  });
  const valueToIndex = /* @__PURE__ */ new Map();
  const tabsRef = React43.useRef(null);
  const tabListRef = React43.useRef(null);
  const externalForwardedProps = {
    slots,
    slotProps: {
  ...
  const handleScrollbarSizeChange = React43.useCallback((scrollbarWidth) => {
  ...
  let childIndex = 0;
  const children = React43.Children.map(childrenProp, (child) => {
...
true ? Tabs.propTypes = {
   ...
   * @default false
   */
  allowScrollButtonsMobile: import_prop_types35.default.bool,
  /**
   ...
   * @default false
   */
  centered: import_prop_types35.default.bool,
  /**
   * The content of the component.
   */
   ...
   * @default 'primary'
   */
  indicatorColor: import_prop_types35.default.oneOfType([import_prop_types35.default.oneOf(["primary", "secondary"]), import_prop_types35.default.string]),
  /**
   ...
   */
  ScrollButtonComponent: import_prop_types35.default.elementType,
  /**
   ...
   * @default 'auto'
   */
  scrollButtons: import_prop_types35.default.oneOf(["auto", false, true]),
  /**
  ...
  slotProps: import_prop_types35.default.shape({
    ...
    indicator: import_prop_types35.default.oneOfType([import_prop_types35.default.func, import_prop_types35.default.object]),
    ...
    scrollbar: import_prop_types35.default.oneOfType([import_prop_types35.default.func, import_prop_types35.default.object]),
    scrollButtons: import_prop_types35.default.oneOfType([import_prop_types35.default.func, import_prop_types35.default.object]),
    scroller: import_prop_types35.default.oneOfType([import_prop_types35.default.func, import_prop_types35.default.object]),
  ...
  slots: import_prop_types35.default.shape({
    ...
    EndScrollButtonIcon: import_prop_types35.default.elementType,
    indicator: import_prop_types35.default.elementType,
    list: import_prop_types35.default.elementType,
    root: import_prop_types35.default.elementType,
    scrollbar: import_prop_types35.default.elementType,
    scrollButtons: import_prop_types35.default.elementType,
    scroller: import_prop_types35.default.elementType,
   ...
   * @default  {}
   */
  TabIndicatorProps: import_prop_types35.default.object,
  /**
   ...
   * @default {}
   */
  TabScrollButtonProps: import_prop_types35.default.object,
  /**
   * Determines the color of the `Tab`.
   * @default 'primary'
   */
  textColor: import_prop_types35.default.oneOf(["inherit", "primary", "secondary"]),
  /**
   ...
   * @default 'standard'
   */
  variant: import_prop_types35.default.oneOf(["fullWidth", "scrollable", "standard"]),
  /**
   * If `true`, the scrollbar is visible. It can be useful when displaying
   * a long vertical list of tabs.
   * @default false
   */
  visibleScrollbar: import_prop_types35.default.bool
} : void 0;
...
var Button = React46.forwardRef(function Button2(inProps, ref) {
  ...
  const loadingId = useId_default(idProp);
  const loadingIndicator = loadingIndicatorProp ?? (0, import_jsx_runtime38.jsx)(CircularProgress_default, {
    "aria-labelledby": loadingId,
    color: "inherit",
    size: 16
  });
  ...
  const startIcon = (startIconProp || loading && loadingPosition === "start") && (0, import_jsx_runtime38.jsx)(ButtonStartIcon, {
    className: classes.startIcon,
    ownerState,
    children: startIconProp || (0, import_jsx_runtime38.jsx)(ButtonLoadingIconPlaceholder, {
      className: classes.loadingIconPlaceholder,
      ownerState
    })
  });
  const endIcon = (endIconProp || loading && loadingPosition === "end") && (0, import_jsx_runtime38.jsx)(ButtonEndIcon, {
    className: classes.endIcon,
    ownerState,
    children: endIconProp || (0, import_jsx_runtime38.jsx)(ButtonLoadingIconPlaceholder, {
      className: classes.loadingIconPlaceholder,
      ownerState
    })
  });
  ...
  const loader = typeof loading === "boolean" ? (
    ...
    (0, import_jsx_runtime38.jsx)("span", {
      ...
      children: loading && (0, import_jsx_runtime38.jsx)(ButtonLoadingIndicator, {
        className: classes.loadingIndicator,
        ownerState,
  ...
  return (0, import_jsx_runtime38.jsxs)(ButtonRoot, {
    ownerState,
...
true ? Button.propTypes = {
   ...
   * @default <CircularProgress color="inherit" size={16} />
   */
  loadingIndicator: import_prop_types36.default.node,
  /**
   * The loading indicator can be positioned on the start, end, or the center of the button.
   * @default 'center'
   */
  loadingPosition: import_prop_types36.default.oneOf(["center", "end", "start"]),
  /**
   * The size of the component.
   * `small` is equivalent to the dense button styling.
   * @default 'medium'
...
var PopperTooltip = React47.forwardRef(function PopperTooltip2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime39.jsx)(Root, {
    ...rootProps,
...
var Popper = React47.forwardRef(function Popper2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime39.jsx)(Portal_default, {
    disablePortal,
    container,
    children: (0, import_jsx_runtime39.jsx)(PopperTooltip, {
      anchorEl,
      direction,
      disablePortal,
      modifiers,
...
var Popper3 = React48.forwardRef(function Popper4(inProps, ref) {
  ...
  return (0, import_jsx_runtime40.jsx)(PopperRoot, {
    as: component,
    direction: isRtl ? "rtl" : "ltr",
    slots: {
      root: RootComponent
...
var Cancel_default = createSvgIcon((0, import_jsx_runtime45.jsx)("path", {
...
var Chip = React54.forwardRef(function Chip2(inProps, ref) {
  ...
  if (onDelete) {
    ...
    }) : (0, import_jsx_runtime46.jsx)(Cancel_default, {
  ...
  return (0, import_jsx_runtime46.jsxs)(ChipRoot, {
    as: component,
    className: clsx_default(classes.root, className),
    ...
    ...moreProps,
    ...other,
    children: [avatar || icon, (0, import_jsx_runtime46.jsx)(ChipLabel, {
...
var ListItemText = React56.forwardRef(function ListItemText2(inProps, ref) {
  ...
  if (primary != null && primary.type !== Typography_default && !disableTypography) {
    primary = (0, import_jsx_runtime48.jsx)(PrimarySlot, {
  ...
  if (secondary != null && secondary.type !== Typography_default && !disableTypography) {
    secondary = (0, import_jsx_runtime48.jsx)(SecondarySlot, {
      variant: "body2",
      color: "textSecondary",
      ...secondarySlotProps,
      children: secondary
...
var DialogContent = React58.forwardRef(function DialogContent2(inProps, ref) {
  ...
  return (0, import_jsx_runtime50.jsx)(DialogContentRoot, {
    className: clsx_default(classes.root, className),
    ownerState,
    ref,
    ...other
...
var DialogContext = React59.createContext({});
if (true) {
...
var Dialog = React60.forwardRef(function Dialog2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiDialog"
  });
  ...
  const backdropClick = React60.useRef();
  const handleMouseDown = (event) => {
  ...
  const dialogContextValue = React60.useMemo(() => {
    return {
  ...
  return (0, import_jsx_runtime51.jsx)(RootSlot, {
    ...
    children: (0, import_jsx_runtime51.jsx)(TransitionSlot, {
      ...transitionSlotProps,
      children: (0, import_jsx_runtime51.jsx)(ContainerSlot, {
        onMouseDown: handleMouseDown,
        ...containerSlotProps,
        children: (0, import_jsx_runtime51.jsx)(PaperSlot, {
          as: PaperComponent,
          elevation: 24,
          role: "dialog",
          "aria-describedby": ariaDescribedby,
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-LXLMH2FV.js.map
