...
function useCurrentColorScheme(options) {
  ...
  const modeStorage = React29.useMemo(() => storageManager?.({
    key: modeStorageKey,
    storageWindow
  }), [storageManager, modeStorageKey, storageWindow]);
  const lightStorage = React29.useMemo(() => storageManager?.({
    key: `${colorSchemeStorageKey}-light`,
    storageWindow
  }), [storageManager, colorSchemeStorageKey, storageWindow]);
  const darkStorage = React29.useMemo(() => storageManager?.({
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-S6HUENDH.js.map
